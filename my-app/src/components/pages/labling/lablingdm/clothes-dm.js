...
function ClothesDM() {
    return (
        <div>
            <Header />
            <p className="head-title">маркировка товаров легкой промышленности</p>
            ...
            иные варианты обработки товаров с последующей маркировкой.
                        маркировку товара с навесом ярлыков.'>
            <p> <br/>Код ТН ВЭД ЕАЭС Товаров легкой промышленности, подлежащих маркировке: 
            <span className="numbers"> <br/>34203 10 000, 6106, 6201, 6202, 6302</span></p>
            </CategoryAbout>
            <Tarrif>
               <ProductCard title={'Комплексная услуга по маркировке товаров кодом DataMatrix на СВХ и ТС'} subtitle={'10₽ / ед.'} src={img.clothes}>МПЛК “Бремино-Орша” / ТЛЦ “Бремино-Брузги” / ТЛЦ “Бремино-Берестовица”</ProductCard>
