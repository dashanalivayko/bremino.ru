...
function ShoesDM() {
    return (
        <div>
            ...
            <Tarrif>
               <ProductCard title={'Комплексная услуга по маркировке товаров кодом DataMatrix на СВХ и ТС'} subtitle={'10₽ / ед.'} src={img.shoes}>МПЛК “Бремино-Орша” / ТЛЦ “Бремино-Брузги” / ТЛЦ “Бремино-Берестовица”</ProductCard>
               <ProductCard className="row-reverse" title={'Комплексная услуга по маркироке товаров кодом DataMatrix без верификации и валидации. Партия товара не более 3SKU '} subtitle={'1.76₽ / ед.'} src={img.tapki}>МПЛК “Бремино-Орша”</ProductCard>
