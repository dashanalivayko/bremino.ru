...
function ParfumeDM() {
    return (
        <div>
            <Header />
            <p className="head-title">маркировка духов</p>
            ...
            маркировку товаров без розничной упаковки с нанесением стикера на флакон;
            маркировку товара с навесом ярлыков.'>
            <p> <br/>Код ТН ВЭД ЕАЭС Духов и туалетной воды, подлежащих маркировке:
            <span className="numbers"> <br/>3303 00 </span></p>
            </CategoryAbout>
            <Tarrif>
               ...
               <ProductCard className="row-reverse" title={'Комплексная услуга по маркироке товаров кодом DataMatrix без верификации и валидации. Партия товара не более 3SKU '} subtitle={'1.76₽ / ед.'} src={img.duhi}>МПЛК “Бремино-Орша”</ProductCard>
