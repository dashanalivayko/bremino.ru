...
function TireDM() {
    return (
        <div>
            <Header />
            <p className="head-title">маркировка шин и покрышек</p>
            ...
            маркировку товаров с нанесением специализированного стикера на изделие;
            маркировку товаров с нанесением термотрансферного стикера на заводскую этикетку;'>
            <p> <br/>Код ТН ВЭД ЕАЭС Шин и покрышек, подлежащих маркировке: 
            <span className="numbers"> <br/>4011 10 000 3,
                                            4011 10 000 9,
                                            4011 20 100 0,
                                            4011 20 900 0,
                                            4011 40 000 0,
                                            4011 70 000 0,
                                            4011 80 000 0,
                                            4011 90 000 0 </span></p>
            </CategoryAbout>
            <Tarrif>
               <ProductCard title={'Комплексная услуга по маркировке легковых шин (в том числе для мотоциклов и моторных ТС) DataMatrix на СВХ и ТС'} subtitle={'10₽ / ед.'} src={img.tire}>МПЛК “Бремино-Орша” / ТЛЦ “Бремино-Брузги” / ТЛЦ “Бремино-Берестовица”</ProductCard>
               <ProductCard className="row-reverse" title={'Комплексная услуга по маркировке промышленных и специализированных шин DataMatrix на СВХ и ТС'} subtitle={' от 74₽ / ед.'} src={img.tire}>МПЛК “Бремино-Орша” / ТЛЦ “Бремино-Брузги” / ТЛЦ “Бремино-Берестовица”</ProductCard>
