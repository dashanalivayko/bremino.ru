...
function WaterDM() {
    return (
        <div>
            <Header />
            <p className="head-title">маркировка питьевой воды</p>
            ...
            иные варианты обработки товаров с последующей маркировкой.
                        маркировку товара с навесом ярлыков.'>
            <p> <br/>Код ТН ВЭД ЕАЭС питьевой воды: 
            <span className="numbers"> <br/>номера</span></p>
            </CategoryAbout>
            <Tarrif>
               <ProductCard title={'Комплексная услуга по маркировке товаров кодом DataMatrix на СВХ и ТС'} subtitle={'10₽ / ед.'} src={img.water}>МПЛК “Бремино-Орша” / ТЛЦ “Бремино-Брузги” / ТЛЦ “Бремино-Берестовица”</ProductCard>
