...
import truck from '../../../assets/cross-docking.svg'
import shelf from '../../../assets/shelf.svg'
import orsha from '../../../assets/breminoorsha.png'
            ...
            <div className="wrapper">
                    ...
                    <div className="about__cntainer">
                        <div className="about__items">
                            ...
                            <div className="about__items-link">
                                <img src={play} className="about__items-iconplay" alt="logo" />
                        ...
                        <div className="about__behold">
                            <div className="about__behold-box">
                                <div className="about__behold-item">
                                    <img src={label} className="about__behold-icon" alt="logo" />
                                    <p className="about__behols-title">
                                        Более 135 млн. промаркированных eдиниц товаров
                                </p>
                                </div>
                                <div className="about__behold-item">
                                    <img src={warehouse} className="about__behold-icon" alt="logo" />
                                    <p className="about__behols-title">
                                        Более 135 млн. промаркированных eдиниц товаров
                                </p>
                                </div>
                            ...
                            <div className="about__behold-box">
                                <div className="about__behold-item">
                                    <img src={truck} className="about__behold-icon" alt="logo" />
                                    <p className="about__behols-title">
                                        Более 135 млн. промаркированных eдиниц товаров
                                </p>
                                </div>
                                <div className="about__behold-item">
                                    <img src={shelf} className="about__behold-icon" alt="logo" />
                                    <p className="about__behols-title">
                                        Более 135 млн. промаркированных eдиниц товаров
                                </p>
                                </div>
                ...
                <div className="about__complex">
                    ...
                    <div className="about__complex-desc">
                        ...
                        <img src={orsha} className="about__items-iconplay" alt="logo" />
                    </div>
                </div>
                <div className="about__complex">
                    <h1 className="about__complex-title">
